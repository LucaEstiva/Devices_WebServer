...
class Server_HTTP_Handler(BaseHTTPRequestHandler):
...
try:
	...
	server = HTTPServer(('', PORT_NUMBER), Server_HTTP_Handler)
	print("Started httpserver on port: " , PORT_NUMBER)
	
	# Attende le richieste http, fino a quando il programma non verrà volutamente terminato
